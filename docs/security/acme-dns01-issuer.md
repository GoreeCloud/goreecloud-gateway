...
- approved operator execution of ACME account registration/TOS review plus protected external wrapping-key provisioning, escrow/recovery, and restore testing;
