...
- approved operator execution/human TOS review using the now-wired account-registration tool, approved wrapping-key provisioning/escrow and target recovery rehearsal, operator wiring and recovery activation policy for the now-transactional CA account-key rollover boundary and read-only authority probe, plus live CA/Porkbun issuance and renewal acceptance over the established RFC 8555 DNS-01 issuer;
