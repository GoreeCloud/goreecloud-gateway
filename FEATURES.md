...
- approved operator execution/human TOS review using the now-wired account-registration tool, approved wrapping-key provisioning/escrow and target recovery rehearsal, key rollover, plus live CA/Porkbun issuance and renewal acceptance over the now-established RFC 8555 DNS-01 issuer;
